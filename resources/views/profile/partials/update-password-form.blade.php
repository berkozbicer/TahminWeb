<section>
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600">
            {{ __('Hesabınızın güvenliğini sağlamak için uzun ve rastgele bir şifre kullandığınızdan emin olun.') }}
        </p>
    </header>
    ...
    <form method="post" action="{{ route('password.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            <x-input-label for="update_password_password_confirmation" :value="__('Yeni Şifre Tekrarı')"/>
